  ...
  return (
    <>
      <PageHeader
        section="FIBRAS"
        title="Divine Alpaca"
        subtitle="Bajo % de medulación. La suavidad perfecta."
      ...
      <section className="bg-cream py-20">
        <div className="max-w-5xl mx-auto px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              { title: 'Bajo % de medulación', desc: 'Las fibras meduladas son la causa del prickle effect o picazón. Divine Alpaca las ha reducido casi por completo mediante selección genética, no por proceso industrial.' },
