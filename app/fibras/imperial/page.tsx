          ...
          <FadeUp>
            <div className="flex items-center justify-center">
              <div className="relative">
                <div className="w-72 h-72 rounded-full bg-cream border-2 border-gold/30 flex items-center justify-center">
                  <div className="text-center">
                    <p className="font-serif text-5xl text-gold mb-2">I</p>
                    <p className="text-xs tracking-[0.2em] uppercase text-ink/40">Imperial Alpaca</p>
                  </div>
                </div>
