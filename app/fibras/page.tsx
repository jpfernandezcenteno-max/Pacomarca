...
const fibers = [
  {
    ...
    desc: 'La innovación más sofisticada de Pacomarca. Divine Alpaca es el resultado de décadas de selección genética orientada a eliminar las fibras meduladas del vellón, logrando una suavidad comparable al Cashmere pero con las propiedades únicas de la alpaca.',
    partners: 'Kuna, Amano',
    bgColor: 'bg-cream',
