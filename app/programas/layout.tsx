...
export const metadata: Metadata = {
  ...
  description: 'Programas sociales de Pacomarca: Cabaña del Pastor, Lote de Machos, Abrigando Corazones, Invernadero, Módulo de Esquila y Fondo de Investigación.',
  openGraph: {
