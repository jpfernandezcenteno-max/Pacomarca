...
export const metadata: Metadata = {
  ...
  description: 'Donación de reproductores machos genéticamente seleccionados para mejorar la fibra de las comunidades alpaqueras. 1,605 alpacas donadas por Pacomarca.',
  openGraph: {
